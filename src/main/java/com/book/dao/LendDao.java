...
public class LendDao {
    ...
    private static final String BOOK_LEND_SQL_TWO = "UPDATE book_info SET state = 0 WHERE book_id = ? AND state = 1";
    private static final String BOOK_LEND_ROLLBACK_SQL = "UPDATE book_info SET state = 1 WHERE book_id = ? AND state = 0";
    ...
    public int rollbackBookLend(long bookId) {
        return jdbcTemplate.update(BOOK_LEND_ROLLBACK_SQL, bookId);
    }
