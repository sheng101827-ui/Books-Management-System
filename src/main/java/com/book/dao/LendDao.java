...
public class LendDao {
    ...
    private final static String RENEW_BACK_DATE_SQL="UPDATE lend_list SET back_date = ? WHERE sernum = ?";
    ...
    public int renewBackDate(long sernum, Date newBackDate){
        return jdbcTemplate.update(RENEW_BACK_DATE_SQL, new Object[]{df.format(newBackDate), sernum});
    }
}
